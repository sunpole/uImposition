...
- без совместимого прайса стоимость исключается и не превращается в `0`.
...
4. не смешивать work-and-turn с separate-front/back;
...
9. не начинать M7.5 до checkpoint `0.7.0-alpha.4`.
