...
1. подготовить release news и uNews/Telegram payload;
2. сохранить focused evidence в постоянный archive;
3. синхронизировать `VERSION.json`, `VERSION.md`, package и видимую версию;
4. создать recovery branch `release/v0.7.0-alpha.3`;
5. создать immutable tag `v0.7.0-alpha.3`;
6. опубликовать GitHub prerelease.
