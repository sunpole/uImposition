...
- M7 — 6 патчей: выбор оператором, стоимость и несколько целей;
...
- тест: приоритет `бумага` выбирает `3305/112`, а `формы` или `стоимость` выбирают компактный `3395/8` в иллюстративном прайсе;
...
- Pareto-frontier;
- обязательные крайние варианты: минимум бумаги, стоимости, форм, пластин, перетиража и прогонов;
- человеческое объяснение преимущества и цены каждого варианта;
- денежные дельты по бумаге, формам и итогу;
