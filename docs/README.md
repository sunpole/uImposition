...
| [`D3_START_PAGE.md`](D3_START_PAGE.md) | **Активная реализация стартового экрана** | Компактный table-first экран заказа внутри `/app/`, связанный с существующими state, calculation, alternatives, layout и PDF |
