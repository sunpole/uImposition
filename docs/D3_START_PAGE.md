...
Одновременно чёрная только одна строка. Когда существующая строка не выбрана, активна верхняя строка нового заказа. После выбора или копирования существующего заказа активной высоты `38 px` становится его строка, а верхний пустой draft возвращается к обычной высоте `24 px`.
