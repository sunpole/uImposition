...
function emptyCost(pricingStatus = PRICING_STATUS.INCOMPLETE) {
  return Object.freeze({
    ...
    layoutFormPreparationPrice: null,
    paperWeightKg: null,
    paperCost: null,
    colorPlateCost: null,
...
function normalizeProductionCost(productionCost, metrics) {
  ...
  return Object.freeze({
    ...
    paperPricePerKg: nonNegativeNumber(
      productionCost.paperPricePerKg,
      "productionCost.paperPricePerKg",
    ),
    colorPlatePrice: nonNegativeNumber(
      productionCost.colorPlatePrice,
      "productionCost.colorPlatePrice",
    ),
    layoutFormPreparationPrice: nonNegativeNumber(
      productionCost.layoutFormPreparationPrice,
      "productionCost.layoutFormPreparationPrice",
    ),
...
export function createSolutionMetrics({
  ...
  const normalized = Object.freeze({
    ...
    paperPricePerKg: normalizedCost.paperPricePerKg,
    colorPlatePrice: normalizedCost.colorPlatePrice,
    layoutFormPreparationPrice: normalizedCost.layoutFormPreparationPrice,
