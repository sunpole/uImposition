...
export function validateMultiProductSeparateDuplexColumn(column) {
  ...
  if (column.family !== "multiProductSeparateDuplexColumn") {
    throw new RangeError("column.family must be multiProductSeparateDuplexColumn");
  }
  if (column.strategy !== "separateFrontBackFormsCandidate") {
    throw new RangeError("column.strategy must be separateFrontBackFormsCandidate");
  }
