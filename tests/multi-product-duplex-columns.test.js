...
test("P1-C exact capacity 4 / two-demand catalog contains 14 columns", () => {
  ...
  assert.equal(catalog.coverage.multipleColumnPlansEvaluated, false);
...
test("P1-C validator rejects corrupted mirrored back, family and strategy", () => {
  ...
  assert.throws(() => validateMultiProductSeparateDuplexColumn({
    ...valid,
    family: "wrong",
  }), /column.family/);
  assert.throws(() => validateMultiProductSeparateDuplexColumn({
